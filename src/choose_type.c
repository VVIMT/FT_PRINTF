...
/*   Updated: 2017/06/22 23:25:33 by vinvimo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		var_1(const char *format, va_list *ap, t_types *t, int *ret)
{
	...
	&& t->length == 4)
		...
		*ret = get_d(t, (char)va_arg(*ap, int));
			...
			|| ((format[t->index] == 'd' || format[t->index] == 'i')
	&& t->length == 2))
...
{
	if ((format[t->index] == 'd' || format[t->index] == 'i') && t->length == 12)
	...
	else if (format[t->index] == 'u' && t->length == 12)
...
int		var_3(const char *format, va_list *ap, t_types *t, int *ret)
{
	...
	else if (format[t->index] == 'o' && t->length == 12)
